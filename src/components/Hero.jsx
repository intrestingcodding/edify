...
const Hero = () => {
  return (
    <div
      ...
      className=" min-h-[90vh] bg-no-repeat bg-[url(https://demo.awaikenthemes.com/weebix/wp-content/uploads/2024/04/hero-bg.png)] grid gap-5  py-16  max-w-6xl mx-auto px-4 items-center md:grid-cols-2 "
    >
      <div className="py-10">
        <div className="">
